...
ggplot(data = mu.2014.df %>% filter(mean < 8.5), 
  ...
  ylab("") + 
  labs(title = "Hatchling production at 2014R and contol sites")

if (save.fig)
  ggsave(filename = "figures/hatchling_production_2014R.png",
         device = "png", dpi = 600)
```
...
ggplot(data = mu.2017.df %>% filter(mean < 8.5), 
  ...
  xlab("Hatchling production per sector") +
  ylab("") + 
  labs(title = "Hatchling production at 2017R and contol sites")

if (save.fig)
  ggsave(filename = "figures/hatchling_production_2017R.png",
         device = "png", dpi = 600)
```
...
ggplot(data = mu.2019.df %>% filter(mean < 8.5), 
  ...
  xlab("Hatchling production per sector") +
  ylab("") + 
  labs(title = "Hatchling production at 2019R and contol sites")

if (save.fig)
  ggsave(filename = "figures/hatchling_production_2019R.png",
         device = "png", dpi = 600)
```
