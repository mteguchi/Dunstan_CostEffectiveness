...
#### 2017R sector
For this approach, the 2017R sector had to be analyzed seprately because the data for the sector were available only for 2017.  The model fit well to the data (Figure 6).
...
beta.yr.sector.total.summary %>% filter(Sector == "West") %>%
  filter(Season == 2017) -> beta.yr.sector.West2017.summary

beta.yr.sector.total.summary[(beta.yr.sector.total.summary$Sector == "2017R" & beta.yr.sector.total.summary$Season != "2017"), c("total_q2.5", "total_q50", "total_q97.5")] <- NA

beta.yr.sector.total.summary[(beta.yr.sector.total.summary$Sector == "West" & beta.yr.sector.total.summary$Season != "2017"), c("total_q2.5", "total_q50", "total_q97.5")] <- NA
...
knitr::kable(poly.log.total.median.wide, 
             digits = 0,
             format.args = list(big.mark = ","),
             caption = "Table 4. Median imputed total hatchling production based on Fourier discrete series and random initial values. ")
```
...
knitr::kable(poly.log.total.q2.5.wide, 
             digits = 0,
             format.args = list(big.mark = ","),
             caption = "Table 4a. Lower 95% CI for imputed total hatchling production based on Fourier discrete series and random initial values. ")
```
...
knitr::kable(poly.log.total.q97.5.wide, digits = 0,
             format.args = list(big.mark = ","),
             caption = "Table 4b. Upper 95% CI for imputed total hatchling production based on Fourier discrete series and random initial values. ")
...
Assuming that these sample represent the entire sectors, we extrapolated the imputed numers to the entire sectors (Figure 15, Table 4). 
...
knitr::kable(poly.total.median.wide, 
             digits = 0,
             format.args = list(big.mark = ","),
             caption = "Table 5. Median imputed total hatchling production based on Fourier discrete series and random initial values. ")
```
...
knitr::kable(poly.total.q2.5.wide, 
             digits = 0,
             format.args = list(big.mark = ","),
             caption = "Table 5a. Lower 95% CI for imputed total hatchling production based on Fourier discrete series and random initial values. ")
```
...
knitr::kable(poly.total.q97.5.wide, digits = 0,
             format.args = list(big.mark = ","),
             caption = "Table 5b. Upper 95% CI for imputed total hatchling production based on Fourier discrete series and random initial values. ")
...
For this approach, rather than imputing the missing values, I estimated the parameters of the function from data and predicted the missing values based on the function.  (The similar imputation approach resulted in poor estimation of parameters.)
...
Qualitatiely, the functions fit well to the data (Figure 16). These imputed counts for each season were summed to provide the total number of hatchlings per 100 m for each season.   Because the parameters were shared among sectors, estimates were available even when there were limited data. 
...
knitr::kable(Girondot.total.median.wide, 
             digits = 0,
             format.args = list(big.mark = ","),
             caption = "Table 6. Median imputed total hatchling production based on Fourier discrete series and random initial values. ")
```
...
knitr::kable(Girondot.total.q2.5.wide, 
             digits = 0,
             format.args = list(big.mark = ","),
             caption = "Table 6a. Lower 95% CI for imputed total hatchling production based on Fourier discrete series and random initial values. ")
```
...
knitr::kable(Girondot.total.q97.5.wide, digits = 0,
             format.args = list(big.mark = ","),
             caption = "Table 6b. Upper 95% CI for imputed total hatchling production based on Fourier discrete series and random initial values. ")
