...
In this section, I use a statistical model to estimate the number of hatchlings during the second half of the night from the first half. The number of observed hatchlings per meter was modeled as a function of time of night (hrs since 1800), year, sector, and survey, which was treated as a random effect. 

I was going to use GAM but that's not going to work... I think I have to estimate the proportion of the second half as a function of covariates then estimate the number from the estimated proportion and the observed first half. 2022-11-23
