...
```{r observed-counts, fig.cap="Observed numbers of hatchling per 100 m within six sectors (2014R, 2017R, 2019R, South, North, and West) on Raine Island. 2014R, 2017R, and 2019R sectors were re-profied in respective years, whereas the other three have not been modified.", echo=FALSE, warning=FALSE}
