...
For the new dataset, this model doesn't work well. It crashes during MCMC. 
...
if (!file.exists(paste0("RData/Fourier_X0_imputation_dnorm_", Day1, "_", Day2, "_2021.rds"))){
  jm <- jags(jags.data,
             inits = NULL,
             parameters.to.save= jags.params,
             model.file = 'models/model_Fourier_imputation_X0_dnorm.txt',
  ...
  saveRDS(jm, paste0("RData/Fourier_X0_imputation_dnorm_", Day1, "_", Day2, "_2021.rds"))
  
} else {
  jm <- readRDS(paste0("RData/Fourier_X0_imputation_dnorm_", Day1, "_", Day2, "_2021.rds"))
}
...
if (!file.exists(paste0("RData/Fourier_imputation_dnorm_", Day1, "_", Day2, "_2021.rds"))){
  jm <- jags(jags.data,
             inits = NULL,
             parameters.to.save= jags.params,
  ...
  saveRDS(jm, paste0("RData/Fourier_imputation_dnorm_", Day1, "_", Day2, "_2021.rds"))
  
} else {
  jm <- readRDS(paste0("RData/Fourier_imputation_dnorm_", Day1, "_", Day2, "_2021.rds"))
}
...
```{r}
all.summary <- summary.stats(stats_X)
...
if (!file.exists(paste0("RData/Fourier_beta_yr_sector_imputation_dnorm_", Day1, "_", Day2, "_2021.rds"))){
  jm <- jags(jags.data,
             inits = NULL,
             parameters.to.save= jags.params,
  ...
  saveRDS(jm, paste0("RData/Fourier_beta_yr_sector_imputation_dnorm_", Day1, "_", Day2, "_2021.rds"))
  
} else {
  jm <- readRDS(paste0("RData/Fourier_beta_yr_sector_imputation_dnorm_", Day1, "_", Day2, "_2021.rds"))
}
