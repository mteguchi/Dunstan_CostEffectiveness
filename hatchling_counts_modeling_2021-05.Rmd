...
n.days <- as.numeric(as.Date(paste0("2021-", Day2)) - as.Date(paste0("2017-", Day1)))
...
# In the new data, there are zeros, which cause problems taking log. So, I add a small number to 
# each value
